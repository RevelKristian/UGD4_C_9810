...
import com.example.revel_ks.ugd4_c_9810.adapter.NotesAdapter;
        ...
        new AlertDialog.Builder(MainActivity.this)
                ...
                .setItems(new String[]{"Delete", "Update"}, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        switch (i) {
                            case 0: new AlertDialog.Builder(MainActivity.this)
                                    .setTitle("Yakin ingin dihapus ?")
                                    .setItems(new String[]{"Delete", "Cancel"}, new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            switch (i) {
                                                case 0:noteDatabase.getNoteDao().deleteNote(notes.get(pos));
                                                    notes.remove(pos);
                                                    listVisibility();
                                                    break;
                                                case 1:
